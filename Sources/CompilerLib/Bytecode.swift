...
case pushLiteralConstant8 = 0x28 // 40
...
case pushLiteralConstant12 = 0x32 // 50
...
case pushLiteralConstant1C = 0x3C // 60
...
case pushLiteralVariable6 = 0x46 // 70
...
case pushLiteralVariable10 = 0x50 // 80
...
case pushLiteralVariable1A = 0x5A // 90
...
case pushOne = 0x76
case pushTwo = 0x77
case returnSelf = 0x78 // 120
case returnTrue = 0x79
case returnFalse = 0x7A
case returnNil = 0x7B
case returnTop = 0x7C
case returnTopFromBlock = 0x7D
case unused7E = 0x7E
case unused7F = 0x7F
case pushLong = 0x80
case storeLong = 0x81
case popLong = 0x82 // 130
case sendLong = 0x83
...
case jumpLong0 = 0xA0 // 160: 1 extension (0-4)*256 + next
...
case jumpLongOnTrue2 = 0xAA // 170: 1 extension 2*256 + next
...
case sendNoArgLiteral2 = 0xD2 // 210
...
case sendNoArgLiteralC = 0xDC // 220
...
case sendOneArgLiteral6 = 0xE6 // 230
...
case sendTwoArgLiteral0 = 0xF0 // 240
...
case sendTwoArgLiteralA = 0xFA // 250
